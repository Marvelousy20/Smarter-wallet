      ...
      <div className="px-6 mt-[4.1rem] relative z-10">
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-x-6 justify-center items-center">
            ...
            <p className="text-[0.75rem] font-300 text-opacity-80 leading-[1rem] text-white pt-1">
              Demand
            </p>
            <p className="text-[0.75rem] font-300 leading-[1rem] text-white text-opacity-80">
              authentication
            </p>
          </div>
          <div className="flex flex-col gap-x-6 justify-center items-center">
            <Image src="/vector.svg" alt="vector" width={24} height={24} />
            <p className="text-[0.75rem] font-300 leading-[1rem] text-white text-opacity-80 pt-1">
              Account
            </p>
            <p className="text-[0.75rem] font-300 leading-[1rem] text-white text-opacity-80">
              Abstraction
          ...
          <div className="text-[0.75rem] font-300 leading-[1rem] text-white flex flex-col justify-center items-center">
            ...
            <p className="text-[0.75rem] font-300 leading-[16px] text-white text-opacity-80 pt-1">
              Automated
            </p>
            <p className="text-[0.75rem] font-300 leading-[1rem] text-white text-opacity-80">
              AI trading bot
        ...
        <div className="space-y-5 mt-12">
          <Button
            className="bg-white h-12 w-full rounded-[80px] text-black text-sm font-semibold hover:text-white"
